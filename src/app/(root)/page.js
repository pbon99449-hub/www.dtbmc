    ...
    <main className="bg-[#DDF3FF] text-[#123B4A]">
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-[#DDF3FF]/60"></div>
        <motion.div
      ...
      <section className="py-20 px-6 md:px-20 bg-[#EAFBFF]">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold mb-6 text-[#2A7F9E]">
              প্রধান শিক্ষকের বার্তা
            </h2>
            <p className="text-[#123B4A] leading-relaxed mb-6">
              আমাদের লক্ষ্য হলো উচ্চমানের কারিগরি শিক্ষা প্রদান করা
              যা শিক্ষার্থীদের তাদের ক্যারিয়ার এবং জীবনে সফল হতে সাহায্য করে।
              আমরা শৃঙ্খলা, উদ্ভাবন এবং উৎকর্ষতায় বিশ্বাস করি।
            </p>
            <Link
              href="/about"
      ...
      <section className="py-20 px-6 md:px-20 bg-[#D8F3F0]">
        <div className="max-w-6xl mx-auto text-center mb-12">
          ...
          <p className="text-[#123B4A] mt-4">
            আমাদের একাডেমিক বিভাগ এবং প্রোগ্রামগুলি ঘুরে দেখুন
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {["কম্পিউটার প্রযুক্তি", "ব্যবসা ব্যবস্থাপনা", "মানব সম্পদ"].map(
            (dept, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <p className="text-[#123B4A] mb-6">
                  ভবিষ্যতের সাফল্যের জন্য তৈরি উচ্চমানের পাঠ্যক্রম।
                </p>
                <Link
                  href="/Departments"
                  className="text-[#2A7F9E] font-semibold hover:underline"
      ...
      <section className="py-20 px-6 md:px-20 bg-[#EAFBFF]">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {[
            "ভর্তি সংক্রান্ত তথ্যের জন্য অফিসে যোগাযোগ করুন", 
            "পরীক্ষার সময়সূচী নোটিশ বোর্ডে নিয়মিত প্রকাশ করা হয়",
            "কলেজের সহশিক্ষা কার্যক্রম সারা বছর চলমান থাকে"
          ].map((notice, index) => (
            <motion.div
              key={index}
            ...
            >
              <p className="font-medium text-[#123B4A]">{notice}</p>
            </motion.div>
          ))}
        </div>
      </section>
